    ...
    <>
      <main>
        <div className="rounded-2xl relative  overflow-hidden max-h-[150px] sm:max-h-[100px]">
          <div className="absolute top-0 left-0 w-full h-full bg-slate-800 bg-opacity-70"></div>
          <img className="w-full h-full object-cover" src="/images/food.jpg" />
          <div className="absolute flex  left-0 top-0 w-full h-full p-6 justify-between sm:items-center lg:aspect-[321/25]">
            <div className="pr-2">
              <TextF
                size="xl"
                color="custom"
