        ...
        <Box className="w-full h-auto flex flex-col">
          ...
          <div className="flex flex-col justify-between h-full relative">
            ...
            <div
              className={`${
                isVisible && "fadein"
              } flex flex-col rounded-none h-auto transition-all  ${
                openSetting
                  ? "pt-8  overflow-hidden max-h-[400px]"
                  : "max-h-[49px]"
              }`}
            >
              <DividerX />
              <div
                className={`rounded-lg transition-colors p-3 px-4 my-2 w-fdivl flex justify-between items-center ${
                  !isVisible && "md:justify-center"
                }`}
              >
              ...
              <ul
                className={`${isVisible && "fadein"} pl-2 flex-col h-full ${
                  openSetting
                    ? "scrollbar-aside-setting overflow-auto flex"
                    : "hidden"
                }`}
              >
                {menuSetting.map((e, i) => (
                  <li
                    key={i}
                    className="rounded-lg hover:bg-gradientbuttonend transition-colors p-3 px-3 my-1"
                  >
                    <Link
                      to={e.path}
                      className={`w-full flex items-center ${
